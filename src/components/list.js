        ...
        <li className='listItem border-bottom pb-2'>
          ...
          {this.props.listitems.map((item,i) => {
            return < div key={i}>
              ...
              <li className='listItem ' id={'listItem'+i  } key={i}>
              <div className='itemName '  id={'itemName'+i  }>{item.name}</div>
              <div className='itemQuantity ' id={'itemQuantity' + i}>{item.quantity}</div>
